package org.trmga.oil.contract;
...
public class TC003_VerifUserIsAbleToCreateOilContractWithNonMandatoryFieldsTest {
	
	@Test
	public void tC003_VerifUserIsAbleToCreateOilContractWithNonMandatoryFieldsTest() throws IOException, InterruptedException {
      ...
      //wait
        ...
        //create object for login object repo
    		...
    		WebElement savebutton = login.getSaveButton();
    		
    		wUtil.toWaitForElement1(driver, savebutton, 10);
